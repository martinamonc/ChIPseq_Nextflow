include { CALL_PEAKS                   } from '.././processes/CALL_PEAKS.nf'
include { CALL_BROADPEAKS                   } from '.././processes/CALL_BROADPEAKS.nf'
include { FILTER_PEAKS                   } from '.././processes/FILTER_PEAKS.nf'
include { ANNOTATE_PEAKS                   } from '.././processes/ANNOTATE_PEAKS.nf'
