...
include { PHANTOM_PEAK_QUAL                   } from '.././processes/PHANTOM_PEAK_QUAL.nf'
include { INSERT_SIZE                   } from '.././processes/INSERT_SIZE.nf'
include { PLOT_FINGERPRINT                   } from '.././processes/PLOT_FINGERPRINT.nf'
